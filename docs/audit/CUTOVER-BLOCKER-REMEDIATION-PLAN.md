...
| CB-04 - ClaimItem authority ban | `ClaimItem.collectedAmount` veya derived remaining display authority olamaz. | Contract/docs/test guard ile negative authority kuralini koru. | Evrak/kalem projection'i hukuki bakiye gibi okunmaz. | Diagnostic/provenance evidence. | Contract/evidence PR; semantic cleanup sonraya. |
