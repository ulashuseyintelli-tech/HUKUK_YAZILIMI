...
export default function NewTaxOfficeForm({
	close,
	offices,
	setOffices,
	office,
	...
	return (
		<Modal visible close={() => close()}>
			...
			>
				<p className="blue bold mb-4 fs-md">Yeni Vergi Dairesi</p>
				<label>
					<span className="fw-500">Vergi Dairesi Adı</span>
					<Input
				...
				<div className="flex al-center mt-2">
					<label className="column w-50 mr-4">
						<span className="fw-500">Vergi Dairesi İli</span>
						<select
					...
					<label className="column w-50">
						<span className="fw-500">Vergi Dairesi İlçesi</span>
						<select
							className="input my-2"
							value={district}
				...
				<label>
					...
					<Input
						textarea
						placeholder="Bu Vergi Dairesi ile ilgili eklemek istediğiniz bir not varsa buraya yazın"
						value={notes}
						classes="mt-2"
