...
from .api_views_action_list import ActionListViewSet
from .api_views_risk_report import RiskNetReportViewSet
from .api_views_weekly_export import WeeklyExportViewSet
...
router.register(r"actions", ActionListViewSet, basename="actions")
router.register(r"risk-report", RiskNetReportViewSet, basename="risk-report")
router.register(r"weekly-export", WeeklyExportViewSet, basename="weekly-export")
