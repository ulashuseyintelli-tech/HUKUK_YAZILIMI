...
class JobRunSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = JobRun
        fields = ["id", "case_id", "debtor_id", "recipe_id", "recipe_version", "status", "risk_level", "priority", "started_at", "finished_at", "attempt", "max_attempts", "lock_blocked_by", "last_error_code", "last_error_message", "steps"]
