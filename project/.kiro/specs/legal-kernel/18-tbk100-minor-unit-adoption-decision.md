...
**Önkoşul:** legal sign-off **+** ulas'ın açık "devam" onayı
...
- Doğrulanmış örnekler (R1 prototip, 2026-06-07):
  ...
  - `remainingPayment: 234.5569999999999 → 234.55`
...
- [ ] **Legal sign-off** (sub-cent policy + örnek değer değişimleri)
- [ ] **ulas açık "devam" onayı** (implementation başlatma)
- [ ] Implementation + kademe-2 capture + characterization güncelleme (ayrı PR)

---
**Decision Status:** Accepted, pending legal sign-off + explicit go. Implementation NOT started.
