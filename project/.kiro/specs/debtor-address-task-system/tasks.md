...
- [x] 2. Address Utility Fonksiyonları
  ...
  - [x] 2.2 Address hash property testi yaz
...
- [x] 3. Checkpoint - Veritabanı ve Utility Testleri
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. TaskEngine Core Service
  ...
  - [x] 4.2 Task idempotency property testi yaz
  ...
  - [x] 4.3 Task state machine transitions implement et
  ...
  - [x] 4.4 SLA Monitor ve Scheduler implement et
  ...
  - [x] 4.5 SLA reminder property testi yaz
...
- [x] 8. Address Service
  ...
  - [x] 8.3 Document address extraction implement et
    - Evraktan adres çıkarma (şimdilik manuel/simüle)
    - addressCategory = DECLARED_DOCUMENT
    - _Requirements: 2.2, 2.3, 2.4_

- [x] 9. Audit Log Service
  - [x] 9.1 AuditLogService implement et
  ...
  - [x] 9.2 Audit log completeness property testi yaz
...
- [x] 10. Checkpoint - Services Testleri

- [x] 11. Flow: Müvekkile Adres Talebi
  - [x] 11.1 CLIENT_CONTACT_VALIDATE flow implement et
    - İletişim bilgisi kontrolü
    - Yoksa manuel görev oluştur
    - _Requirements: 3.1, 3.2, 3.3, 3.4, 3.5_

  - [x] 11.2 Contact validation blocking property testi yaz
  ...
  - [x] 11.3 CLIENT_REQUEST_DEBTOR_ADDRESSES flow implement et
    - Mesaj gönderimi
    - WAITING_EXTERNAL durumuna geçiş
    - dueAt = now + 3 days
    - _Requirements: 4.1, 4.2, 4.3, 4.4, 4.5, 4.6_

  - [x] 11.4 Hatırlatma mekanizması implement et
    - 3 günde bir hatırlatma
    - attemptCount artırma
    - 3. denemede manuel görev oluşturma
    - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5_

  - [x] 11.5 Escalation property testi yaz
...
- [x] 12. Checkpoint - Flow Testleri

- [x] 13. API Endpoints
  - [x] 13.1 Task API endpoints oluştur
...
- [x] 17. UI: Müvekkil Teyit Checkbox
  - [x] 17.1 Borçlu oluşturma formuna "Adres müvekkilden alındı" checkbox ekle
  ...
  - [x] 17.2 Checkbox state'ini backend'e gönder
    - `clientConfirmed: boolean` field'ı request body'ye ekle
    - _Requirements: 23.2, 23.3_

- [x] 18. Backend: Address Intake Mode
  - [x] 18.1 Debtor modeline `addressIntakeMode` field ekle
    - Enum: `CLIENT_CONFIRMED`, `UNKNOWN`, `NEEDS_CLIENT_REQUEST`
    - Migration oluştur (zaten mevcut)
    - _Requirements: 28.1, 28.2, 28.3, 28.4_

  - [x] 18.2 Debtor create endpoint'ini güncelle
...
- [x] 19. TaskEngine: Bypass Rules
  - [x] 19.1 `shouldBypassAddressRequest()` fonksiyonu implement et
...
- [x] 20. TaskEngine: Auto-Completion Rules
  - [x] 20.1 `autoCompleteOnAddressReceived()` fonksiyonu implement et
  ...
  - [x] 20.2 onAddressesReceived event handler implement et
    - CLIENT_REPLY veya CLIENT_CONFIRMED_UI source'larını dinle
    - autoCompleteOnAddressReceived() çağır
    - _Requirements: 25.1_

  - [x] 20.3 "Zaten aldık" butonu için endpoint ekle
    - POST /api/address-tasks/:taskId/confirm-received
    - doneReason = CONFIRMED_BY_OPERATOR
    - _Requirements: 26.1, 26.2, 26.3, 26.4_

- [x] 21. UI: Task Panel Updates
  - [x] 21.1 CLIENT_REQUEST_DEBTOR_ADDRESSES task'larına "Zaten aldık" butonu ekle
    - Butona tıklanınca confirm-received endpoint'i çağır
    - Task panelinden kaldır
    - _Requirements: 26.1, 26.2_
    - (OperationDeck.tsx'te zaten mevcut)

  - [x] 21.2 Debtor kartlarına "Yararlı adres var" indicator ekle
    - hasUsefulAddresses() sonucuna göre göster
    - SelectedDebtorCard.tsx'e eklendi
    - _Requirements: 27.4_

- [x] 22. Checkpoint - Bypass & Auto-Completion Testleri
  - [x] 22.1 Bypass property testi yaz
    - *For any* CLIENT_CONFIRMED debtor ile useful address varsa, address request task oluşturulmamalı
    - **Validates: Requirements 24.1, 24.2**

  - [x] 22.2 Auto-completion property testi yaz
