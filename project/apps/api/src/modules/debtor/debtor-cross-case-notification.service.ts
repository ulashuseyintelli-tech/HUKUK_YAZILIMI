...
/**
 * D6A-2 — Shared Debtor Cross-Case Notification (persisted, targeted push).
 *
 ...
 *
 * D6A-1 (debtor-cross-file-alerts, pull/computed drawer banner) ile birlikte yaşar — o AYRI
 * bir sistemdir (AuditLog-tabanlı, contact dahil, hedefsiz). Bu servis yalnız D6A-2'dir.
 *
