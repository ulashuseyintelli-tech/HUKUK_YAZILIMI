...
export const FAULT_SCENARIOS: FaultScenario[] = [
  ...
  { id: 'F6',  surface: 'phase7_pipeline',  fault: 'external_api_fault',      expectedContract: 'terminal_500_no_retry',    expectedHttpClass: 500, tier: 2, active: true },
  { id: 'F7',  surface: 'phase7_pipeline',  fault: 'partial_response',        expectedContract: 'terminal_500_no_retry',    expectedHttpClass: 500, tier: 2, active: true },
