...
export class ClientOffsetService {
  ...
  // ROLL-001: DispositionPostingService (reimbursement APPLY) AYNI key'i üretir (expense-remaining-lock.ts) —
  // cross-service advisory-lock serialize için iki servis de BİREBİR aynı string'i üretmeli.
