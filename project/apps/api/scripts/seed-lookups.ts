...
async function main() {
  ...
  const takipTurleri = [
    ...
    { code: 'ILAMLI', name: 'İlamlı Takip', description: 'Mahkeme kararına dayalı takip', sortOrder: 3 },
    { code: 'NAFAKA', name: 'Nafaka', description: 'Nafaka alacağı takibi', sortOrder: 4 },
    { code: 'KAMBIYO_CEK', name: 'Kambiyo - Çek', description: 'Çeke dayalı takip', sortOrder: 5 },
    { code: 'KAMBIYO_SENET', name: 'Kambiyo - Senet', description: 'Senede dayalı takip', sortOrder: 6 },
    { code: 'REHIN_TASINIR', name: 'Rehin - Taşınır', description: 'Taşınır rehni paraya çevirme', sortOrder: 7 },
    { code: 'REHIN_TASINMAZ', name: 'Rehin - Taşınmaz (İpotek)', description: 'İpotek paraya çevirme', sortOrder: 8 },
  ];
  ...
  const mahiyetTipleri = [
    ...
    { code: 'KREDI', name: 'Kredi Kartı / Banka Alacağı', description: 'Banka ve kredi kartı borçları', uyapCode: null, sortOrder: 4 },
    { code: 'NAFAKA', name: 'Nafaka Alacağı', description: 'Nafaka alacağı takibi', uyapCode: '201', sortOrder: 5 },
    { code: 'KIRA_FARK', name: 'Kira Farkı / Ecrimisil', description: 'Kira farkı ve ecrimisil alacağı', uyapCode: null, sortOrder: 6 },
    { code: 'FATURA', name: 'Fatura Alacağı', description: 'Fatura ve cari hesap alacağı', uyapCode: null, sortOrder: 7 },
    { code: 'CEK', name: 'Çek Alacağı', description: 'Çeke dayalı alacak', uyapCode: null, sortOrder: 8 },
    { code: 'SENET', name: 'Senet Alacağı', description: 'Senede dayalı alacak', uyapCode: null, sortOrder: 9 },
    { code: 'TAZMINAT', name: 'Tazminat Alacağı', description: 'Mahkeme kararına dayalı tazminat', uyapCode: null, sortOrder: 10 },
    { code: 'ICRA_INKAR', name: 'İcra İnkâr Tazminatı', description: 'İcra inkâr tazminatı içeren dosya', uyapCode: null, sortOrder: 11 },
    { code: 'ISCILIK', name: 'İşçilik Alacağı', description: 'İşçilik ve kıdem tazminatı alacağı', uyapCode: null, sortOrder: 12 },
  ...
  const takipTuruDefaults: Record<string, { mahiyetKodu: string; borcluTipiKodu: string }> = {
    ...
    'REHIN_TASINIR': { mahiyetKodu: 'KREDI', borcluTipiKodu: 'GERCEK_KISI' },
    'REHIN_TASINMAZ': { mahiyetKodu: 'KREDI', borcluTipiKodu: 'GERCEK_KISI' },
  };
