...
/**
 * CLIENT-P2-U01-R1 — PortalLayout'un kendi bağımsız portal_token guard'ı: yalnız 3 recovery
 ...
 */
describe("PortalLayout — public recovery vs private portal boundary (CLIENT-P2-U01-R1)", () => {
  beforeEach(() => {
    pushMock.mockClear();
    localStorage.clear();
