...
8. **TASARIM-GATED (kod değil, ulas kararı gerekir):** RFA-010 (ghost-relations: gizle vs "pasif" etiket?), RFA-009 (Debtor soft-delete, migration, IR/Party ile). Düşük: RFA-014/015 (LOW), RFA-011 (API-only, UI=NO), RFA-012 (LOW).

> **B-SINIFI MEKANİK FIX HATTI TAMAMLANDI** (RFA-016/017/005/006/008/013/007). Kalan açık işler tasarım-kararı veya düşük öncelik.
