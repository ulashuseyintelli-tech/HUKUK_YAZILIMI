...
**DBP-P2-UYAP-CONNECTOR-CHARTER-01 — UYAP CONNECTOR DELIVERY ROADMAP RECONCILIATION (2026-07-20, bkz. `decision-log.md` aynı tarihli kayıt; canonical home `project/docs/blueprint/DEBTOR-UYAP-CONNECTOR-CHARTER-v1.0.md`):** `DBP-P2-UYAP-CONNECTOR-MASTER-01` GO-ANALYZE (owner-accepted) sonucu, yukarıdaki P01-P04B-VAL-R1-GOV/P02B-R2 zinciri (bu belgedeki tüm önceki notlar dahil) **hiçbiri reopen edilmeden veya yeniden analiz edilmeden**, yeni bir Connector Charter'da **8-dilimli connector delivery roadmap'ine** yeniden çerçevelendi: (1) Charter/authority-boundaries, (2) transport/auth/credential (YENİ, henüz canonicalize edilmedi), (3) Contract A payload adapter (bu zincirin kendisi, SUBSTANTIALLY CANONICAL/residuals open: P04D-INSTRUMENT/P03B/typed-wrapper/official-acceptance), (4) Contract B/portal adapter (SEPARATE/OPEN, hâlâ hiç açılmadı), (5) request evidence/audit (YENİ), (6) local simulator (P04B-VAL-I1+P04A-ENC temel, FOUNDATION EXISTS), (7) shadow execution (mevcut kimlik `P04C-SHADOW` korundu, BAŞLATILMADI), (8) controlled production cutover (mevcut kimlik `P05` korundu, NOT AUTHORIZED). **NORTH STAR:** çalışan/güvenli/tenant-isolated/denetlenebilir/controlled-cutover UYAP connector — Contract A/B semantiği bu connector'ın payload-bağımlılığıdır, nihai ürün DEĞİLDİR. **P04B-EXT-01/02/03 precision (owner-mandated):** NON-REPOSITORY OWNER-SESSION ACTIVITY, ACTUAL SEND UNCONFIRMED, REPOSITORY EVIDENCE NONE, CANONICAL EXTERNAL AUTHORITY STATUS NOT YET OBTAINED — gönderildiği veya cevap alındığı İDDİA EDİLMEDİ. **KORUNAN:** P01-P02B-R2 arasındaki her CLOSED/CANONICAL birimin statüsü UNCHANGED; P04B-VAL-I2 BLOCKED/HOLD; **UYAP CUTOVER HARD HOLD.** Bu not production/test/schema/migration DEĞİŞTİRMEZ; TRANSPORT-AUTH-01/EVIDENCE-01/SIMULATOR-01/P04D-INSTRUMENT/P03B/Contract B/P04C-SHADOW/P05 BAŞLATMAZ. **NEXT ELIGIBLE TASK (güncel): OWNER SELECTION — `TRANSPORT-AUTH-01` / `EVIDENCE-01` / `SIMULATOR-01` GO-ANALYZE, hiçbiri NOT STARTED.**
