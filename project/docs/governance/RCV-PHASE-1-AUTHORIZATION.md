...
Next eligible action        : TPA-04A CANONICAL SNAPSHOT / BUCKET IDENTITY CONTRACT — OWNER GO-ANALYZE REQUIRED
```
...
NEXT ELIGIBLE ACTION     : TPA-04A SNAPSHOT / BUCKET IDENTITY ANALYSIS — OWNER GO-ANALYZE REQUIRED
OWNER GO                 : REQUIRED
...
TPA-04A NEXT / SNAPSHOT + BUCKET IDENTITY ANALYSIS / OWNER GO-ANALYZE REQUIRED
