...
| `REC-AUTH-012` — Payment allocation | TBK100 ve geçerli validation ile legal allocation sonucu | RECEIVABLE/COLLECTION legal-allocation owner | `CURRENT WITH OPEN RECONCILIATION` | `CONFIRMED / DA-4 DRIFT BASELINE IMPLEMENTED; WS04-P01 FORMALLY CLOSED; WS04-P02 STATIC / SYNTHETIC / DISPOSABLE EVIDENCE PACKAGE FORMALLY CLOSED UPON APPROVED GOVERNANCE MERGE; REPRESENTATIVE / PRODUCTION EVIDENCE NOT EXECUTED / NOT AUTHORIZED; DISPOSITION READINESS NOT ASSESSED; DA-4 / CA-1 / CM-1 ACTIVE SAFE-HOLD; ACT-28 / REC-AUTH-011/012 RECONCILIATION OPEN` |
