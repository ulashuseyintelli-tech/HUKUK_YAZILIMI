...
| `REC-AUTH-012` — Payment allocation | TBK100 ve geçerli validation ile legal allocation sonucu | RECEIVABLE/COLLECTION legal-allocation owner | `CURRENT WITH OPEN RECONCILIATION` | `CONFIRMED / DA-4 DRIFT BASELINE FIRST; ALLOCATOR DISPOSITION DEFERRED; WS04-P01 CONTRACT RATIFIED UPON APPROVED GOVERNANCE MERGE` |
