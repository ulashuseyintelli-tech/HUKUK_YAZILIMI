...
| `REC-AUTH-012` — Payment allocation | TBK100 ve geçerli validation ile legal allocation sonucu | RECEIVABLE/COLLECTION legal-allocation owner | `CURRENT WITH OPEN RECONCILIATION` | `CONFIRMED / DA-4 DRIFT BASELINE IMPLEMENTED; WS04-P01 FORMALLY CLOSED UPON APPROVED GOVERNANCE MERGE; ALLOCATOR DISPOSITION DEFERRED; ACT-28 / REC-AUTH-011/012 RECONCILIATION OPEN` |
