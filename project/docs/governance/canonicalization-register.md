...
- **Disposition:** **OPEN / CUTOVER NOT AUTHORIZED.** VER-05 **OPEN / PR-1A + PR-1B + PR-1C + PR-A2 + PR-A3 IMPLEMENTED / INVENTORY REVIEW PENDING** olarak devam eder.
...
- **Implementation disposition:** PR-1A, PR-1B, PR-1C, PR-A2 ve PR-A3 uygulanmıştır. PR-A4 exact UYAP mapping kabulü ile gerekli inventory/validation kapılarına bağlıdır; PR-A5 yetkilendirilmemiştir. PR-1D schema-migration design gerektirir. Generator hardening, precautionary-cost lifecycle, D6 ve cutover bu uygulamaların kapsamı değildir.
