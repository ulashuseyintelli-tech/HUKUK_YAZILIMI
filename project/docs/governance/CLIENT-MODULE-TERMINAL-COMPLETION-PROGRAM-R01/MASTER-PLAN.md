...
X3 STATUS:                ENGINEERING_COMPLETE — X3 7/7 tamam (2026-08-03).
                          ...
                          B06: promote hattı fresh main'de doğrulandı. Submission-level aday
                          yalnız APPROVED + `promotedRefId=null`; field-level yollar mevcut
                          promotedRef'i yeniden yazmaz. Her canonical create ile promotedRef
                          damgası aynı per-field transaction'dadır; `CLIENT_INTAKE_PROMOTE`,
                          `CLIENT_INTAKE_PROMOTE_ADDRESS` ve `CLIENT_INTAKE_PROMOTE_SOFT`
                          audit yolları korunur. Passive CaseDebtor üç promote girişinde de
