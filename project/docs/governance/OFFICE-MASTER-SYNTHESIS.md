...
| CLIENT-SEC-H2 (audit/entegrasyon log tenant ownership) | IMMEDIATE EXPOSURE: CONTAINED · CODE-LEVEL TENANT ENFORCEMENT: CLOSED · STRUCTURAL OWNERSHIP: OPEN · MIGRATION/BACKFILL: NOT AUTHORIZED · ENDPOINT RESTORATION: NOT AUTHORIZED (bkz. §11 — CLIENT domain finding, `decision-log.md` CLIENT-SEC-H2 kaydı) |
