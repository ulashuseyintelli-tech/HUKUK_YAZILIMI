...
| CLIENT-SEC-H2 (audit/entegrasyon log tenant ownership) | IMMEDIATE EXPOSURE: CONTAINED · CODE-LEVEL TENANT ENFORCEMENT: CLOSED · STRUCTURAL OWNERSHIP: OPEN · SCHEMA P01/P02/P02-R1: CANONICAL (nullable kolon + new-write population) · P03 BACKFILL EVIDENCE: ANALYSIS COMPLETE, PRODUCTION READINESS INSUFFICIENT EVIDENCE (temsili veri yok) · P04 PRODUCTION BACKFILL: NOT ELIGIBLE / BLOCKED · ENDPOINT RESTORATION: NOT AUTHORIZED (bkz. §11 — CLIENT domain finding, `decision-log.md` CLIENT-SEC-H2 + CLIENT-SEC-H2C-P03 kayıtları) |
