...
| ADR-013 | Fee / Harç / Snapshot / Journal owner-review draft | `docs/adr/ADR-013-FEE-HARC-SNAPSHOT-JOURNAL.md` | DRAFT / OWNER REVIEW REQUIRED / NARROW RECEIPT-BOUND SUBTYPE RATIFIED | General Fee/Harç/Journal/presentation snapshot ownership ve lifecycle açık kalır. Yalnız TPA-04A `CanonicalReceivableApplicationSnapshotV1` receipt-bound LegalApplication subtype'ı ratifiye edilmiştir; runtime/schema/writer/cutover authority yoktur. |
| ADR-014 | CCB-001 Canonical Legal Calculation Core — target legal-calculation and application authority constitution | `docs/adr/ADR-014-CCB-001-CANONICAL-LEGAL-CALCULATION-CORE.md` | LOCKED / ALLOCATION-AUTHORITY AMENDED / TPA-02 + TPA-03 + TPA-04 + TPA-04A RATIFIED / TPA-03A FOUNDATION CLOSED / SHADOW_ONLY / RUNTIME CUTOVER NOT AUTHORIZED | Balance Engine + canonical Receivable snapshot + bucket/TBK100 policy target authority'dir; ClaimItem application target değildir. TPA-04A Option C, receipt-bound `CanonicalReceivableApplicationSnapshotV1`, exact eligibility/envelope, RCV-CAS/v1 hash/serialization, deterministic bucket identity ve pure plan input'unu ratifiye eder. General ADR-013 açık; TPA-04B+ ayrı owner gate. Synthetic corpus writer/evidence/cutover blocker; PR #407 final disposition B ile CLOSED/UNMERGED, requirements preserved, code discarded; ACT-28 ve REC-AUTH-011/012 OPEN. |
...
| ADR-013 | Fee / Harç / Snapshot / Journal architecture | DRAFT / OWNER REVIEW REQUIRED; TPA-04A NARROW SUBTYPE RATIFIED | Bu hattın kanonik ADR numarasıdır; owner-review taslak dosyası `docs/adr/ADR-013-FEE-HARC-SNAPSHOT-JOURNAL.md` olarak oluşturuldu. CCB-001'in mimari dokümanı DEĞİLDİR (bkz. ADR-014). Yalnız receipt-bound `CanonicalReceivableApplicationSnapshotV1` alt türü TPA-04A ile ratified; general producer ownership, Fee/Harç/Journal lifecycle, implementation sequence ve runtime davranış açık/unauthorized kalır. |
