...
| ADR-014 | CCB-001 Canonical Legal Calculation Core — target legal-calculation and application authority constitution | `docs/adr/ADR-014-CCB-001-CANONICAL-LEGAL-CALCULATION-CORE.md` | LOCKED / ALLOCATION-AUTHORITY AMENDED / TPA-02 + TPA-03 + TPA-04 + TPA-04A + TPA-04B RATIFIED / TPA-03A FOUNDATION CLOSED / SHADOW_ONLY / RUNTIME CUTOVER NOT AUTHORIZED | Balance Engine + canonical Receivable snapshot + bucket/TBK100 policy target authority'dir; ClaimItem application target değildir. TPA-04B required-evidence contract canonical TEXT payload, required/default-free/no-backfill fields, identity/uniqueness, bucket arithmetic ve DB aggregate conservation'ı ratifies; exact two-file implementation owner-gated'dir. Synthetic corpus writer/evidence/cutover blocker; PR #407 CLOSED/UNMERGED/NO FURTHER ACTION; ACT-28 ve REC-AUTH-011/012 OPEN. |
