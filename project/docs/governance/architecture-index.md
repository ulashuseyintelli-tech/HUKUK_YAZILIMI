...
| ADR-014 | CCB-001 Canonical Legal Calculation Core — target legal-calculation and application authority constitution | `docs/adr/ADR-014-CCB-001-CANONICAL-LEGAL-CALCULATION-CORE.md` | LOCKED / ALLOCATION-AUTHORITY AMENDED / TPA-02 + TPA-03 + TPA-04 RATIFIED / TPA-03A FOUNDATION CLOSED / SHADOW_ONLY / RUNTIME CUTOVER NOT AUTHORIZED | Balance Engine + canonical Receivable snapshot + bucket/TBK100 policy target authority'dir; ClaimItem application target değildir. TPA-04 Option C, official snapshot + target-native `LegalApplicationPlan` tüketen dormant `LegalApplicationWriter`ı tek persistence writer olarak ratifiye eder; writer policy hesaplamaz veya legacy/ClaimItem target türetmez. Snapshot/bucket SHA-256 identity, pre-writer DB conservation, replay, APPLY/full reversal ve transaction-bound audit canonicaldır. TPA-04A..G ayrı owner gate'leridir. Synthetic corpus legacy evidence/blocker; PR #407 HOLD/UNTOUCHED; ACT-28 ve REC-AUTH-011/012 OPEN; implementation/cutover/retirement unauthorized. |
