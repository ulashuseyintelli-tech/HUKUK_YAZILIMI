...
| ADR-014 | CCB-001 Canonical Legal Calculation Core | LOCKED (direction; PR-gated) — dosya oluşturuldu | CCB-001'in kanonik mimari kaydıdır ve dosyası `docs/adr/ADR-014-CCB-001-CANONICAL-LEGAL-CALCULATION-CORE.md` olarak oluşturulmuştur (2026-07-10, owner arbitration). Fee/Harç/Snapshot/Journal için kullanılmaz — o `ADR-013`'tür (ayrı draft/owner-review ADR olarak mevcuttur). |
