...
Status: **ACTIVE_LEGACY_FIELD_REQUIRES_OWNER / PRODUCTION TRACE REQUIRED** — implemente EDİLMEDİ. Sıradaki görev: `CAN-P0-002-B-FIX` (dar owner tasarımı, production-trace-gate korunarak).
