...
Unlock Condition: PR-10 technical + governance closure sonrası sıradaki uygun adım owner-gated **`UNASSIGNED` cutover-authorization governance decision**'dır. PR-11 consumer switch bu karar kapanmadan yetkili değildir. Mandatory canonical merge/closure sırası korunur.
