...
**GUNCEL (2026-09-13) — R02:** CLIENT D3 engelleyicilerini #2657 @ `88b3d07a` (R05) ile duzeltti; OFFICE 33 kaynakta dogruladi ve yeni hash'leri olctu (§9 `9804FEF6…` · T-AC `CA99E69E…` · T-KAPA `0A80982B…`). Tek nihai paket **R02** (`release23-candidate-r01/RELEASE23-TEK-NIHAI-PAKET-R02.md`) R01'in yerine gecer; tek kosullu owner GO taslagi owner onayina sunulur. D3 yurutucusu yukseltilmis pencere (owner). Canli degisiklik YOK.
