...
Unlock Condition: **CLOSED / SATISFIED.** Wave 0 Acceptance Criteria, Master Register closures, W0.1/W0.2/W0.3, Conditional Option B, PR-1A, PR-1B, PR-2 ve PR-3h canonical main'e dahil edilmiştir. Bu scenario-infra kaydı yeniden açılmaz; sıradaki unresolved ADR-014 teknik dilimi PR-4'tür ve kendi closure sırasını izler.
...
**POST-PR-3h CURRENT-STATUS OVERRIDE (2026-07-11):** Aşağıdaki uzun `Status` paragrafı W0 uygulamasının tarihsel teslim kaydı olarak korunur; içindeki `W0 IMPLEMENTATION IN PROGRESS` ve `sıradaki PR-1A/PR-1B` ifadeleri current status değildir. Güncel authoritative durum: **W0.1/W0.2/W0.3 CLOSED / CANONICAL; PR-1A CLOSED / CHARACTERIZATION CANONICAL; PR-1B CLOSED / IMPLEMENTATION CANONICAL; PR-2 CLOSED / NO_BUCKETS FAIL-CLOSED CANONICAL; PR-3h CLOSED / TBK100 CENT-HARDENING CANONICAL; next technical slice PR-4; runtime cutover NOT AUTHORIZED.**
...
Title: ADR-014 Canonical Legal Calculation Core — post-PR-3h split-PR yürütme planı (owner-approved v2.2)
...
Depends On: `ADR-014-SCENARIO-INFRA` (CLOSED/CANONICAL); PR-1A (CLOSED); PR-1B (CLOSED); PR-2 (CLOSED); PR-3h (CLOSED); ADR-014 (LOCKED).
Unlock Condition: PR-3h technical + governance closure sonrası sıradaki teknik hat **PR-4 partial-payment interest-base mutation**'dır. Mandatory canonical merge/closure sırası korunur.
...
Status: **APPROVED / POST-PR-3h BASELINE EXECUTION PLAN v2.2 / DIRECT_RESCUE_MERGE_NO_GO / RESCUE_SOURCE_ONLY (2026-07-11).** W0.1/W0.2/W0.3, Conditional Option B, PR-1A, PR-1B, PR-2 ve PR-3h CLOSED/CANONICAL. Canonical merge, governance closure ve downstream eligibility mandatory sıra izler; paralellik yalnız analiz/hazırlık/branch geliştirmesidir. İlk unresolved teknik dilim PR-4'tür. Duplicate allocator disposition owner-held ve PR-3h dışı kalır. Runtime cutover NOT AUTHORIZED; PR-11/PR-12/PR-14 owner-gated; cutover-auth, PR11-stability, PR12-bake, post-cutover verification ve final ADR closure owner ID atayana kadar `UNASSIGNED` kalır. Ayrıntılı current chain `project/docs/design/adr-014-split-pr-plan.md` §12'dedir.
...
**POST-PR-3h CCB-001 STATUS OVERRIDE (2026-07-11):** Yukarıdaki branch-only CCB-001-R evidence tarihsel kalır ve canonical-main runtime state değildir. Current main için W0 ve PR-1A/PR-1B/PR-2/PR-3h CLOSED/CANONICAL; next technical slice PR-4; duplicate allocator disposition owner-held; ALC-AUTH pilot/rollout kayıtları PR-10/11 altında reconciliation girdisi; runtime cutover NOT AUTHORIZED.
