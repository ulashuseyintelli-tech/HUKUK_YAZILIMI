...
- **Jest cagri sayisi:** ci.yml dogrudan cagri 8→0; toplam (manifest dahil) **16/18 → 8/18** (CI-8 gate ciktisi: `8/18 jest invocation (ci.yml=0, manifest=8)`). Yeni job, paralellestirme, timeout artisi, yeni bagimlilik YOK; urun/fixture/beklenti DEGISMEDI.
