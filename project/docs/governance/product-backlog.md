...
- **BAGLANMAYAN 24 SPEC (13 tekil + 11'lik pdf-poppler grubu) — kok neden + dar onarim onerisi (urun/fixture/mock/beklenti DEGISTIRILMEDI; hepsi owner karari):**
  ...
  | 12 | `ocr/__tests__/poppler-page-renderer.spec.ts` | 12 PASS + **1 skip** | `RUN_POPPLER_INTEGRATION==='1'` degilse `it.skip` (satir 73-74; CI'da poppler yok) | baglanirsa CI'a 1 kosullu skip eklenir; owner: kabul edilir mi? kabulse bagla ve atlama muhasebesine +1 yaz |
