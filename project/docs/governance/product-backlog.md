...
- **BAGLANMAYAN 24 SPEC (13 tekil + 11'lik pdf-poppler grubu) — kok neden + dar onarim onerisi (urun/fixture/mock/beklenti DEGISTIRILMEDI; hepsi owner karari):**
  ...
  | 11 | `calc-preview/.../playbook/__tests__/playbook.golden.spec.ts` | 11 PASS + **1 it.todo** (satir 315) | icsel `it.todo('should trigger immediate rollback on human reject')` | baglanirsa CI'a 1 todo eklenir ("eklenen testler atlanmadan PASS" kosuluna aykiri); todo'yu tamamla/kaldir (SPEC) sonra bagla |
