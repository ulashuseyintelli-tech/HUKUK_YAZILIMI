...
Unlock Condition: Bu owner arbitration kaydı yalnız tasarım kararını sabitler. Implementation AYRI bir GO-IMPLEMENT gerektirir ve REVERSAL yöntemi (`OPEN_OWNER_DECISION`, aşağıda) implementation'dan önce çözülmelidir.
