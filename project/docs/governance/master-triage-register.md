...
|---|---|---|---|---|
| ACT-05 | OCR | G4 — Completeness scoring | Medium | Design #390 §3.4 kilitli — henüz ele alınmadı |
...
| ACT-11 | Client | Yetkisiz kullanıcıya delete/archive butonu gizleme | Low | Henüz ele alınmadı |
...
| ACT-16 | DevOps | strategic-backlog.md → product-backlog.md içerik migration | Low | Henüz ele alınmadı |
...
**KAPANMIŞ/MERGED (ACTIVE'den çıkarıldı, bkz. Bölüm D — Closed Register):** ACT-01 (CLOSED/INVALID/Zombie), ACT-02, ACT-03, ACT-04.
...
- **ACT-26 (cross-case creditor cluster)** zaten bilinen bekleyen DBIND-1 P3 adımı — GO-IMPLEMENT'e hazır olabilir.
...
| Kategori | Sayı |
|---|---|
| Master Product Backlog (ACTIVE) | 23 (ACT-05..26, ACT-01..04 Closed'a taşındı) |
