...
**Son güncelleme:** 2026-07-05 (ACT-09 POST-MERGE GOVERNANCE CHECK)
...
| Kategori | Sayı |
|---|---|
| Master Product Backlog (ACTIVE) | 9 (ACT-20..25, ACT-27..28; ACT-01..17/19/26 Closed'a taşındı; ACT-18→OWN-30 owner-paused; ACT-27/28=ALC-AUTH-* cross-reference) |
...
| Closed Register | 28 (ALC-AUTH-4A + ACT-17 + ACT-19 + ACT-15 + ACT-14 + ACT-11 + ACT-13 + ACT-10 + ACT-12 + ACT-09 eklendi) |
