...
| OFFICE-AUTH-P02-HARDENING-R01 | OWNER-GATED / IMPLEMENTATION NOT STARTED | 5 owner-ratified post-merge hardening residual'i (tenant-user DB integrity, capability flag, serializable+retry, email-compensation, reset-link transport); bkz. `product-backlog.md` § OFFICE-AUTH-P02-HARDENING-R01 |
