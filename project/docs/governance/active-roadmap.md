...
|---|---|---|---|---|---|
| PHASE 1 | Accounting Journal Engine | Posting · Reversal · Idempotency · Reconciliation · Validation · Event Mapping (şema #645 MERGED; partial live writer wiring) | Codex (BE) | NEXT · design-gate-first | Existing wired sources are fail-closed live writer paths; posting-mode helper is not wired as a live gate; DEFAULT-OFF/SHADOW change requires separate owner/mimari decision. ADR-010/legal ledger/TBK100 authority unchanged. Reconciliation gate: `project/docs/finance/acct-1-posting-mode-status-reconciliation-gate.md`. → ACCT-1 |
