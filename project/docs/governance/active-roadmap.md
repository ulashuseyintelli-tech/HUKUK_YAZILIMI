...
| NEXT ELIGIBLE UNIT | ~~WAVE 1 — Candidate Inventory and Slice Decomposition~~ → **CAP-09A-CONSUMER-01 (SLICE 3)** | SUPERSEDED 2026-07-22: owner Phase 2 ilk birimini CAP-09 Audit-Attribution Standard olarak seçti (`decision-log.md` § 2026-07-22 CAP-09 GO-DECIDE). SLICE 1 `CAP-09A-GOV` canonical; SLICE 2 `CAP-09A-FOUNDATION` = `OFFICE-PHASE2-CAP09A-FOUNDATION-I01` IMPLEMENTED + LIVE APPLIED (PR #1536 / `580edd8e`; migration `20260722213239...`, TRAIN-R02 exec `b3b0fa5b8183`); SLICE 3 `CAP-09A-CONSUMER-01` OWNER-AUTHORIZED 2026-07-26 (bkz. `OFFICE-RISK-REGISTER.md` STF-PRD-AUDIT-001 AUTHORITY RECONCILIATION) |
| NEXT ELIGIBLE UNIT (CURRENT) | **OFFICE-P2-CAP02-WORKSTREAM-CANONICALIZATION-RESIDUAL-CHECK-R01** (governance) → **OFFICE-P2-CAP02-REPRESENTATIVE-PERSONNEL-DATA-BOOTSTRAP-PLAN-R01** (technical, GO-ANALYZE / READ-ONLY) | SUPERSEDED 2026-07-26 (`OFFICE-P2-CAP09A-TO-CAP02-SEQUENCE-SUPERSESSION-R01`, owner GO-COMPLETE): üstteki satırın işaret ettiği `CAP-09A-CONSUMER-01 (SLICE 3)` yetkilendirmesi (T5 kararı / PR #1619 / `64d54732`) tarihsel olarak KORUNUR fakat current execution sequence bakımından supersede edilmiştir. Current phase `PHASE 2 — AUTHORIZATION ENFORCEMENT PREPARATION`; primary direction `AUTHORIZATION ENFORCEMENT`; first/primary executable workstream `CAP-02 — OBJECT-SCOPE / REPORTINGLINE`; delivery strategy `POPULATION-FIRST`. CAP-09A `PARALLEL / SOFT / NON-BLOCKING ENABLER`, current first-unit DEĞİL; SLICE 3 `NOT CURRENTLY AUTHORIZED / NOT STARTED`. Bu tablo implementasyon yetkisi VERMEZ |
| OFFICE-AUTH-P02 | BASELINE IMPLEMENTED / CANONICAL (PR #1481, squash `7676d851`, CI 4/4 PASS) | Credential-recovery mimarisi `decision-log.md` § 2026-07-21 "OFFICE-AUTH-P02-GOVERNANCE-ENTRY"'de canonicalize edildi, implementasyon PR #1481 ile merge edildi; bkz. `product-backlog.md` § OFFICE-AUTH-P02. Post-merge owner-ratified sertleştirme açıkları: bkz. `product-backlog.md` § OFFICE-AUTH-P02-HARDENING-R01 |
| OFFICE-AUTH-P02-HARDENING-R01 | **IMPLEMENTED / CANONICAL + LIVE APPLIED** (önceki satır `OWNER-GATED / IMPLEMENTATION NOT STARTED` idi — bayattı, 2026-07-26 düzeltildi) | 5/5 owner-ratified residual kodda doğrulandı (composite `(tenantId,userId)` FK + partial unique index · capability flag + `GET /api/auth/capabilities` · SERIALIZABLE + P2034 retry · 4 ayrı audit action · reset-link URL fragment). Kod: PR #1494, squash `b9916f5b`. Canlı DB: GATE M3 owner GO-MIGRATE, TRAIN-R02 2026-07-23 exec `b3b0fa5b8183` (bkz. `pending-migration-coordination-register.md` §14-17). NOT: `product-backlog.md` § OFFICE-AUTH-P02-HARDENING-R01 hâlâ `OPEN / NOT IMPLEMENTED` diyor; o dosya owner-WIP olduğu için agent tarafından düzeltilemez — owner düzeltmesi bekliyor |
