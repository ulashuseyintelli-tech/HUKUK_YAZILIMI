...
| COL-RISK-G07 | RECEIVABLE–COLLECTION legal-application persistence ve cutover zinciri tamamlanmadı | XD-001 boundary, TPA-02 aggregate, TPA-03 contract ve TPA-03A schema foundation canonicaldır. TPA-04 Option C ayrıca `LegalApplicationWriter` için official canonical Receivable snapshot + target-native `LegalApplicationPlan`, dormant-first transaction-only invocation, snapshot/bucket SHA-256 identity, bigint conservation, replay, APPLY/full-reversal, transaction-bound audit ve fail-closed legacy coexistence kontratını ratifiye eder. Writer TBK100 hesaplamaz ve ClaimItem/collectedAmount/LedgerAllocation/CollectionAllocation üzerinden target üretmez. Ancak snapshot contract, DB conservation amendment, plan builder, dormant writer, reversal writer, representative evidence, consumer cutover ve retirement henüz uygulanmamıştır. | **OPEN — PHYSICAL MODEL + SCHEMA FOUNDATION + WRITER CONTRACT CLOSED / IMPLEMENTATION + EVIDENCE + CUTOVER + RETIREMENT REMAIN** | ACT-28 / REC-AUTH-011/012 OPEN; `codex/rcv-ws04-p03-syn-01` target writer için superseded legacy evidence ve writer/evidence/cutover için BLOCKING; PR #407 OPEN / HOLD / CONFLICTING / DO NOT MERGE / DO NOT REBASE / UNTOUCHED; next TPA-04A snapshot/bucket identity analysis OWNER GO-ANALYZE REQUIRED / NOT AUTHORIZED |
