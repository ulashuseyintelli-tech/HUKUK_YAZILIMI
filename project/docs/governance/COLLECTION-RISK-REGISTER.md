...
| COL-RISK-G05 | valueDate/date çift-tarih için canonical effective-date policy yoktu (historical baseline; governance gap giderildi) | COL/OD-03 Option A: faiz/legal balance yalnız canonical effectiveDate tüketir; authorized explicit effectiveDate yoksa Ledger.entryDate, Collection fallback'inde Collection.date kullanılır; raw tarihler provenance kalır, belirsizlik fail-closed'dur | **CLOSED — GOVERNANCE CONTRACT RECORDED / RUNTIME CHANGE NOT AUTHORIZED** | COL/OD-03 RECORDED; W2.1 implementation, snapshot, backfill ve Phase 2 cutover ayrı owner GO gerektirir |
