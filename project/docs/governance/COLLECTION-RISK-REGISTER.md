...
| COL-RISK-G06 | Official as-of/snapshot runtime'ı yok | TPA-04A Option C receipt-bound `CanonicalReceivableApplicationSnapshotV1` eligibility/identity kontratını; TPA-04B ise exact canonical TEXT payload ve required/default-free/no-backfill persistence contract'ını ratifiye eder. General presentation/Fee/Harç/Journal snapshot lifecycle açık; current Balance Engine SHADOW_ONLY; runtime snapshot/hash writer yoktur. | **PARTIALLY MITIGATED — NARROW CONTRACT + PERSISTENCE CONTRACT RATIFIED / RUNTIME ABSENT** | REC-AUTH-024/025; REC-ALLOC-016/017; broader ADR-013 OPEN; TPA-04B implementation + TPA-04C+ owner-gated |
| COL-RISK-G07 | RECEIVABLE–COLLECTION legal-application persistence ve cutover zinciri tamamlanmadı | XD-001 boundary, TPA-02 aggregate, TPA-03 contract/03A foundation, TPA-04 writer contract, TPA-04A snapshot/bucket identity ve TPA-04B required-evidence schema-amendment contract canonicaldır. TPA-04B exact two-file future patch için canonical TEXT evidence, bucket arithmetic, per-batch uniqueness ve `receipt = applied + held` aggregate conservation'ı ratifiye eder. Ancak schema amendment uygulanmamış; plan builder, dormant/reversal writer, representative evidence, consumer cutover ve retirement yoktur. | **OPEN — PHYSICAL MODEL + FOUNDATION + WRITER/SNAPSHOT/EVIDENCE CONTRACTS CLOSED / IMPLEMENTATION + EVIDENCE + CUTOVER + RETIREMENT REMAIN** | ACT-28 / REC-AUTH-011/012 OPEN; synthetic corpus schema amendment için non-blocking, writer/evidence/cutover için BLOCKING; PR #407 CLOSED/UNMERGED/NO FURTHER ACTION; next `TPA-04B-ENTRY` OWNER GO-VERIFY REQUIRED / implementation NOT AUTHORIZED |
