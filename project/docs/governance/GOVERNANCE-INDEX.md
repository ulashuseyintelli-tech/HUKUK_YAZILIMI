...
| `project/docs/rcv-claim-legal-signer-*` | RECEIVABLE Legal Basis için üç role-separated AWS KMS Ed25519 key ceremony, public-key manifest/checksum, custody/access, possession, rotation/revocation/compromise ve redacted audit evidence pack'i | `RCV-CLAIM-FORM-P02-S08-D02-KC01` CLOSED / CANONICAL / PASS; implementation PR #1856 / `74d1950d`; private custody NON-EXPORTABLE; production signing NOT_ACTIVE; production signature NONE; runtime DORMANT |
| `project/docs/rcv-claim-legal-public-key-trust-root-*` + `project/docs/rcv-claim-legal-signature-envelope-verification-contract-v1.md` | KC01'in üç role-separated Ed25519 public key'ini immutable, checksum-pinned production verification trust root'a bağlayan closed schema, deterministic validator, exact-version dormant resolver, signature-envelope contract ve redacted AWS parity evidence pack'i | `RCV-CLAIM-FORM-P02-S08-D02-TR01` CLOSED / CANONICAL / PASS; implementation PR #1901 / `3472052b`; trust root `RCV-CLAIM-LEGAL-PUBLIC-KEY-TRUST-ROOT@1`, verification ACTIVE, runtime DORMANT, signing NOT_ACTIVE, production signature NONE; next D02-LB01 owner-gated / not started |
