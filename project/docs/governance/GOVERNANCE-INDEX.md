...
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, gerçekleşen phase/workstream progression ve next-workstream owner gate kaydı | CANONICAL / DEC-0030 CLOSED / RCV-GOV-002 CLOSED; RCV-GOV-003 RECONCILIATION PREPARED — CANONICAL UPON APPROVED MERGE; WS01 TECHNICALLY COMPLETE; WS02 OWNER GO REQUIRED |
