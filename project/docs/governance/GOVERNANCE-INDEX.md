...
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01 CLOSED; WS02 CLOSED; RCV-P2-WS03-P01 CLOSED / CANONICAL; RCV-P2-WS03-P02 FORMALLY CLOSED / CANONICAL UPON APPROVED GOVERNANCE MERGE (implementation PR #1316 / `208588d7`); WS03 OPEN; NEXT TASK UNSET — OWNER GO REQUIRED; WS03-P03 NOT AUTHORIZED / NOT STARTED |
