...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL; v1.1 RCV-P2-WS04 allocation-authority amendment (2026-07-18) + v1.2 RD01 balance-exposure contract + v1.3 XD-001 legal-application single-writer cross-domain boundary (2026-07-19) |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.3; v1.0 baseline (2026-07-12; PR #1145 MERGED) + RCV-P2-WS04 allocation-authority amendment (2026-07-18) + RD01 balance-exposure contract + XD-001 authority boundary (2026-07-19); ClaimItem source/input ≠ target LegalCalculationBucket application grain |
