...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL v1.8; v1.1 allocation-authority amendment + v1.2 RD01 + v1.3 XD-001 + v1.4 ClaimItem formation + v1.5 TPA-02 aggregate + v1.6 TPA-03 foundation contract ve TPA-03A evidence + v1.7 TPA-04 writer contract + v1.8 TPA-04A receipt-bound canonical snapshot/bucket identity contract. TPA-04B..G ayrı owner gate; implementation/cutover unauthorized |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.8; ClaimItem source/input ≠ application target; TPA-02 aggregate, TPA-03/03A foundation, TPA-04 writer ve TPA-04A `CanonicalReceivableApplicationSnapshotV1` identity contract'ları canonicaldır. TPA-04B schema analysis, writer implementation, evidence, cutover ve retirement NOT AUTHORIZED |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. TPA-02/03/03A, TPA-04 ve TPA-04A canonical; ACT-28 / REC-AUTH-011/012 OPEN; PR #407 final disposition B ile CLOSED/UNMERGED, requirements preserved, code discarded. TPA-04B writer-evidence schema amendment analysis next / owner-gated; implementation NOT AUTHORIZED. |
...
| `project/docs/governance/COLLECTION-GOVERNANCE.md` | Collection Domain Governance — receipt/lifecycle/allocation-execution sınırı, COL-INV-001..048, cross-domain contract haritası | OWNER-APPROVED CANONICALIZATION v1.6; TPA-04A ile receipt-bound `CanonicalReceivableApplicationSnapshotV1`, deterministic bucket identity ve fail-closed application-plan input'u ratified. Collection receipt lifecycle/outer transaction owner; Receivable snapshot/bucket/policy/plan owner; implementation/cutover unauthorized |
