...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL; v1.1 RCV-P2-WS04 allocation-authority amendment (2026-07-18) + v1.2 RD01 balance-exposure contract + v1.3 XD-001 legal-application single-writer cross-domain boundary + v1.4 RCV-CLAIM-FORM-P01-R01 ClaimItem formation-admission contract + v1.5 TPA-02 independent LegalApplicationBatch persistence architecture + v1.6 TPA-03 Option B contract; TPA-03A exact two-file schema foundation PR #1449 / `63f0b0ea` ile CLOSED / CANONICAL EVIDENCE (2026-07-20), writer/cutover ayrı owner gate |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.6; v1.0 baseline (2026-07-12; PR #1145 MERGED) + RCV-P2-WS04 allocation-authority amendment (2026-07-18) + RD01 exposure + XD-001 boundary + RCV-CLAIM-FORM-P01-R01 formation + TPA-02 independent LegalApplicationBatch architecture + TPA-03 Option B contract; ClaimItem source/input ≠ target LegalCalculationBucket application grain; TPA-03A exact two-file schema foundation PR #1449 / `63f0b0ea` ile CLOSED / CANONICAL, writer/conservation enforcement/replay/cutover/retirement NOT AUTHORIZED |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. Historical P01–P03-A closures preserved. P01/P02 AMENDMENT REQUIRED; P03 SUPERSEDED/REDESIGN; P03-A SAFETY INFRASTRUCTURE ONLY; P03-B DO NOT EXECUTE. RD01 + XD-001 RATIFIED. TPA-02 physical architecture and TPA-03 Option B contract RATIFIED; TPA-03A foundation PR #1449 / `63f0b0ea` CLOSED / CANONICAL. ACT-28 / REC-AUTH-011/012 OPEN; PR #407 HOLD. Writer/data/replay/conservation enforcement/cutover/retirement NOT AUTHORIZED; next TPA-04 analysis owner-gated. |
...
| `project/docs/governance/COLLECTION-GOVERNANCE.md` | Collection Domain Governance — receipt/lifecycle/allocation-execution sınırı, COL-INV-001..048, cross-domain contract haritası | OWNER-APPROVED CANONICALIZATION v1.4; v1.0 baseline (2026-07-13) + RCV-P2-WS04 amendment + XD-001 boundary + TPA-02 physical architecture + TPA-03 Option B contract + TPA-03A PR #1449 / `63f0b0ea` schema-foundation evidence (2026-07-20); Collection receipt lifecycle/idempotency/outer transaction orchestration owner'ıdır, bucket/policy veya bağımsız application authority değildir |
