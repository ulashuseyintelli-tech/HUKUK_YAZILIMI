...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL v1.9; v1.1 allocation authority + v1.2 RD01 + v1.3 XD-001 + v1.4 ClaimItem formation + v1.5 TPA-02 + v1.6 TPA-03/03A + v1.7 TPA-04 + v1.8 TPA-04A + v1.9 TPA-04B required-evidence schema-amendment contract. TPA-04B implementation ve TPA-04C..G ayrı owner gate; runtime/cutover unauthorized |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.9; ClaimItem source/input ≠ application target; TPA-02/03/03A, TPA-04, TPA-04A ve TPA-04B required-evidence schema-amendment contract canonicaldır. Exact two-file implementation TPA-04B-ENTRY owner verify gate'inde; writer/evidence/cutover/retirement NOT AUTHORIZED |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. TPA-02/03/03A, TPA-04/04A/04B contract canonical; ACT-28 / REC-AUTH-011/012 OPEN; PR #407 CLOSED/UNMERGED/NO FURTHER ACTION. Next `TPA-04B-ENTRY — OWNER GO-VERIFY REQUIRED`; implementation NOT AUTHORIZED. |
...
| `project/docs/governance/pending-migration-coordination-register.md` | gerçek hukuk_db'de tespit edilen, henüz live-apply edilmemiş migration kuyruğunun cross-workstream görünürlüğü; domain governance veya implementation izni ÜRETMEZ | LIVING / NON-NORMATIVE (kuruluş 2026-07-21, OFFICE-AUTH-P02-HARDENING-R01-GOMIGRATE-SUSPEND-01); OFFICE (migration #1+#3) SUSPENDED/BLOCKED AT PREFLIGHT, LEGAL APPLICATION (#2) ve CLIENT (#4) ayrı owner yetkisi bekliyor |
...
| `project/docs/blueprint/UYAP-CONNECTOR-MASTER-SYNTHESIS-v1.0.md` | Merkezi UYAP Anayasası — connector-geneli kalıcı anayasal ilkeler, 5+1 modül sınır matrisi, aktör/yetki matrisi, State/Evidence/KVKK-retention/Credential/Transport/Retry/Simulator Constitution'ları, official-source Tier A/B/C sınıflandırması, external dependency register, risk register, A2Z roadmap; Charter'ı reopen etmez | CANONICAL CENTRAL CONSTITUTION (kuruluş `decision-log.md` UYAP-MASTER-SYNTHESIS-01-GOV, 2026-07-21); OD-UYAP-01/02/07 RATIFIED, OD-UYAP-03/04/05/06/08/09/10 AÇIK; IMPLEMENTATION AUTHORITY: NONE; UYAP CUTOVER HARD HOLD korunur; program omurgası KARARLAR 1-11 tescili: `decision-log.md` UYAP-PROGRAM-BACKBONE-01 (2026-07-21) — F0-F8 yalnız planlama/crosswalk görünümü (sentez §18.1) |
| `project/docs/governance/COLLECTION-GOVERNANCE.md` | Collection Domain Governance — receipt/lifecycle/allocation-execution sınırı, COL-INV-001..048, cross-domain contract haritası | OWNER-APPROVED CANONICALIZATION v1.7; TPA-04B required-evidence schema-amendment contract canonical TEXT payload, required evidence, bucket arithmetic ve exact-cent conservation'ı ratifies. Collection receipt lifecycle/outer transaction owner; Receivable snapshot/bucket/policy/plan owner; implementation/cutover unauthorized |
