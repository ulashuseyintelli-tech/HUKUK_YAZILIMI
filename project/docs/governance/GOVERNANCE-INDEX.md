...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.5; v1.0 baseline (2026-07-12; PR #1145 MERGED) + RCV-P2-WS04 allocation-authority amendment (2026-07-18) + RD01 exposure + XD-001 boundary + RCV-CLAIM-FORM-P01-R01 formation + TPA-02 independent LegalApplicationBatch persistence architecture (2026-07-19); ClaimItem source/input ≠ target LegalCalculationBucket application grain; implementation NOT AUTHORIZED |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. Historical P01–P03-A closures preserved. P01/P02 AMENDMENT REQUIRED; P03 SUPERSEDED/REDESIGN; P03-A SAFETY INFRASTRUCTURE ONLY; P03-B DO NOT EXECUTE. RD01 + XD-001 RATIFIED. TPA-02 physical architecture RATIFIED: independent `LegalApplicationBatch`, immutable `LegalApplication`, non-authoritative `ApplicationAttribution`, single writer `LegalApplicationWriter` inside canonical Collection transaction. ACT-28 / REC-AUTH-011/012 OPEN; PR #407 HOLD. Schema/migration/writer/data/replay/cutover/retirement NOT AUTHORIZED. NEXT ACTION TPA-03 SCHEMA-FOUNDATION ANALYSIS — OWNER GO-ANALYZE REQUIRED. |
...
| `project/docs/governance/COLLECTION-GOVERNANCE.md` | Collection Domain Governance — receipt/lifecycle/allocation-execution sınırı, COL-INV-001..048, cross-domain contract haritası | OWNER-APPROVED CANONICALIZATION v1.3; v1.0 baseline (2026-07-13) + RCV-P2-WS04 amendment + XD-001 boundary + TPA-02 physical architecture (2026-07-19); Collection receipt lifecycle/idempotency/outer transaction orchestration owner'ıdır, bucket/policy veya bağımsız application authority değildir |
