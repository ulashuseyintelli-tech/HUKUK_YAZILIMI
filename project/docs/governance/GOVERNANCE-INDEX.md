...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL; v1.1 RCV-P2-WS04 allocation-authority amendment (2026-07-18) |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.1; v1.0 baseline (2026-07-12; PR #1145 MERGED) + RCV-P2-WS04 allocation-authority amendment (2026-07-18); ClaimItem source/input ≠ target LegalCalculationBucket application grain |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. Historical P01–P03-A closures preserved. Current disposition: P01/P02 AMENDMENT REQUIRED; P03 SUPERSEDED / REQUIRES REDESIGN; P03-A SAFETY INFRASTRUCTURE ONLY; P03-B SUPERSEDED / DO NOT EXECUTE. ClaimItem source/provenance/calculation input; target application grain LegalCalculationBucket; LedgerAllocation current AS-IS/legacy; CollectionAllocation compatibility projection only; collectedAmount deprecated cache; Balance Engine TARGET/SHADOW_ONLY. PR #407 HOLD / DO NOT MERGE. ACT-28 / REC-AUTH-011/012 OPEN; data/replay/schema/migration/cutover/WS05/WS06 NOT AUTHORIZED. NEXT ACTION PR #407 POST-AMENDMENT SEMANTIC TRIAGE — OWNER GO REQUIRED. |
