...
| `project/docs/governance/SYSTEM-CONSTITUTION.md` | system-wide semantic authority | RATIFIED / BINDING / CANONICAL; v1.1 RCV-P2-WS04 allocation-authority amendment (2026-07-18) + v1.2 RD01 balance-exposure contract ratification (2026-07-19) |
...
| `project/docs/governance/RECEIVABLE-GOVERNANCE.md` | ratifiye Receivable Domain Governance ve tek domain giriş noktası | RATIFIED / BINDING / CANONICAL v1.2; v1.0 baseline (2026-07-12; PR #1145 MERGED) + RCV-P2-WS04 allocation-authority amendment (2026-07-18) + RD01 balance-exposure contract ratification (2026-07-19); ClaimItem source/input ≠ target LegalCalculationBucket application grain |
| `project/docs/governance/RCV-PHASE-1-AUTHORIZATION.md` | RCV → CCB-001 identity-only program/register cross-pointer'ı, DEC-0030 disposition'ı, formal phase/workstream/package closure ve owner gate kaydı | CANONICAL / DEC-0030 CLOSED; PHASE 1 CLOSED; WS01–WS03 CLOSED; WS04 OPEN. Historical P01–P03-A closures preserved. P01/P02 AMENDMENT REQUIRED; P03 SUPERSEDED/REDESIGN; P03-A SAFETY INFRASTRUCTURE ONLY; P03-B DO NOT EXECUTE. RD01 exposure contract RATIFIED: stable bucket context ≠ snapshot instance; LegalApplication ≠ non-authoritative ApplicationAttribution; public projection per-currency/category-level + fail-closed; current Balance Engine SHADOW_ONLY. PR #407 OPEN/HOLD/DO NOT MERGE/DO NOT REBASE/DO NOT CLOSE YET; code extraction NONE. ACT-28 / REC-AUTH-011/012 OPEN; target persistence analysis READ-ONLY AUTHORIZED; schema/migration design/implementation, data/replay, cutover/WS05/WS06 NOT AUTHORIZED. NEXT ACTION TARGET PERSISTENCE READ-ONLY DESIGN ANALYSIS — OWNER GO REQUIRED. |
